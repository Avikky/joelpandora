					...
					<div class="widget">
						...
						<ul class="arrow nav nav-tabs second-font uppercase">
							<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<li>
									<a href="<?php echo e(url('blogcategory')); ?>/<?php echo e($category->id); ?>/<?php echo e(preg_replace('/\s+/', '-', strtolower($category->name))); ?>">
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\joelpandora\resources\views/blogcategory.blade.php ENDPATH**/ ?>