  ...
  width: calc(33.3333333333% - 48px) !important;
    ...
    <div id="bl-main" class="bl-main">
                    ...
                    <div class="title-heading">
                        <div class="selector uppercase" id="selector">
                            <h3 class="ah-headline p-none m-none">
                                ...
                                <span class="my-name">{{$profile->firstname}} &nbsp; {{$profile->lastname}}</span>
                            ...
                            <br><br>
                            <a href="{{ url('/blog') }}" class="btn btn-blog font-weight-700">
        ...
        <section>
                        ...
                        <div class="col s12 m8 l12 xl12 personal-info section-padding">
                            ...
                            <div class="col s12 m12 l6 p-none">
                                <ul class="second-font list-1">
                                    <li><span class="font-weight-700">First Name: </span>{{ $profile->firstname}}</li>
                                    <li><span class="font-weight-700">Last Name: </span>{{$profile->lastname}}</li>
                                    <li><span class="font-weight-700">Nationality: </span>{{$profile->nationality}}</li>
                                    <li><span class="font-weight-700">State: </span>{{$profile->state}} </li>
                                    <li><span class="font-weight-700">City: </span>{{$profile->city}}</li>
                                </ul>
                            </div>
                            <div class="col s12 m12 l6 p-none">
                                <ul class="second-font list-2">
                                    <li><span class="font-weight-700">Phone: &nbsp;</span>{{$profile->phone}}</li>
                                    <li><span class="font-weight-700">Address: &nbsp;</span>{{$profile->address}}</li>
                                    <li><span class="font-weight-700">Email: &nbsp;</span>{{$profile->email}}</li>
                                    <li><span class="font-weight-700">Spoken Langages: &nbsp;</span>{{$profile->language}}</li>
                                    <li><span class="font-weight-700">Twitter: &nbsp;</span> {{$profile->twitter_handle}}</li>
                                </ul>
                            </div>
                            <a href="{{asset('storage/resume')}}/{{$profile->resume}}" download class="btn font-weight-700">
                                        ...
                                        <div class="resume-card-body experience">
                                            <div class="resume-card-body-container second-font">
                                                ...
                                                <div class="resume-content">
                                                    <h6 class="uppercase">{{$experience->title}}</h6>
                                                    <span class="date"><i class="fa fa-map-marker"></i>{{$experience->company}}</span>
                                                    <br>
                                                    <span class="date"><i class="fa fa-calendar-o"></i>{{$experience->duration}}</span>
                                    ...
                                    <div class="resume-card resume-card-1" data-index="1">
                                        ...
                                        <div class="resume-card-body education">
                                            ...
                                            @foreach($educations as $education)
                                                ...
                                                <div class="resume-content">
                                                    <h6 class="uppercase">{{$education->title}}</h6>
                                                    <span class="date">{{$education->course }}</span>
                                                    <br>
                                                    <span class="date"><i class="fa fa-calendar-o"></i>{{$education->school}}</span>
                                                    <br>
                                                    <span class="date"><i class="fa fa-calendar-o"></i>{{ $education->duration}}</span>
                                            ...
                                            <div class="resume-card-body-container second-font">
                                                <div class="row">
                                                    ...
                                                    <div class="col s6">
                                                        ...
                                                        @foreach($skills->slice(0, 6) as $skill)
                                                            <div class="resume-content">
                                                    ...
                                                    <!-- Skills Row Starts -->
                                                    <div class="col s6">
                                                        @foreach($skills->slice(6, 12) as $skill)
                                                            <div class="resume-content">
                                                                <h6 class="uppercase">{{$skill->skill}}</h6>
                                                                <p>
                                                                    @switch($skill)
            ...
            <!-- End Expanded About -->
            <img alt="close" src="{{ asset('asset/images/close-button.png')}}" class="bl-icon-close" />
        </section>
        <!-- About Ends -->
        <!-- Portfolio Starts -->
                ...
                <div class="container">
                    ...
                    <div class="row center-align da-thumbs" id="bl-work-items">
                        @foreach($projects as $project)
                            <!-- Project Starts -->
                            <div class="col s12 m6 l6 xl4" data-panel="{{$project->id}}">
                                <a href="#">
                                    <img class="responsive-img" src="{{asset('storage/project_images')}}/{{$project->project_image}}" alt="Project" />
                                    <div class="valign-wrapper"><span class="font-weight-700 uppercase">{{$project->project_name}}</span></div>
                                </a>
                            </div>
                            <!-- Project Ends -->
                        @endforeach
                ...
                <div class="container">
                    ...
                    <div class="row contact section-padding">
                        ...
                        <div class="col s12 m5 l5 xl4 leftside">
                            ...
                            <span class="font-weight-400 second-font"><i class="fa fa-phone"></i> {{$profile->phone}}</span>
                            <h6 class="font-weight-700 uppercase">Email</h6>
                            <span class="font-weight-400 second-font"><i class="fa fa-envelope"></i>{{$profile->email}}</span>
                            <h6 class="font-weight-700 uppercase">Address</h6>
                            <span class="font-weight-400 second-font"><i class="fa fa-home"></i>  {{$profile->address}}</span><br>
                            <!-- Contacts Ends -->
                            <!-- Social Media Profiles Starts -->
                            <h6 class="font-weight-700 uppercase">Social Profiles</h6>
                            <div class="social">
                                <ul class="list-inline social social-intro center-align p-none">
                                    <li class="facebook"><a href="{{$profile->facebook_handle}}"  target="_blank"><i class="fa fa-facebook"></i></a></li>
                                        <li class="google-plus"><a href="{{$profile->instagram_handle}}"  target="_blank"><i class="fa fa-instagram"></i></a></li> 
                                    <li class="twitter"><a href="{{$profile->twitter_handle}}"><i class="fa fa-twitter"  target="_blank"></i></a></li>
                                    <li class="linkedin"><a href="{{$profile->linkedin_handle}}"  target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                </ul>
                            </div>
                        ...
                        <div class="col s12 m7 l7 xl8 rightside">
                            ...
                            <form class="contactform" method="post" action="{{ route('contactmail') }}">
                                <!-- Name Field Starts -->
            ...
            <div data-panel="{{$project->id}}">
                <div class="row">
                    ...
                    <div class="col s12 l6 xl6 section-padding">
                        <h3 class="font-weight-700 uppercase">{{$project->project_name}}</h3>
                        <ul class="project-details second-font">
                            <li><i class="fa fa-user"></i><span class="font-weight-700"> Client </span>: <span class="font-weight-400 uppercase">{{$project->designated_client}}</span></li>
                            <li><i class="fa fa-calendar-o"></i><span class="font-weight-700"> Start Date </span>: <span class="font-weight-400 uppercase">{{$project->start_date}}</span></li>
                            <li><i class="fa fa-calendar-check-o"></i><span class="font-weight-700"> End Date </span>: <span class="font-weight-400 uppercase">{{$project->finish_date}}</span></li>
                            <li><i class="fa fa-cogs"></i> <span class="font-weight-700">Description</span> : <span class="font-weight-400 uppercase body">{!! $project->description !!}</span></li>
                        </ul>
                        <hr>
                        <a href="{{$project->project_link}}" target="_blank"class="waves-effect waves-light btn font-weight-700">Preview <i class="fa fa-external-link"></i></a>
                    </div>
        ...
        @endforeach
            ...
            <nav>
                ...
                <img alt="close" src="{{ asset('asset/images/close-button.png') }}" class="control-button bl-icon-close" />
