						...
						<div class="comments">
							...
							<ul class="comments-list">
								<li>
									<!-- Comment Starts -->
									<div class="comment">
									<img class="comment-avatar pull-left" alt="" src="{{asset('asset/images/blog/user1.jpg')}}">
									...
									<ul class="comments-reply">
										<li>
											<!-- Comment Starts -->
											<div class="comment">
											<img class="comment-avatar pull-left" alt="" src="{{asset('asset/images/blog/user2.jpg')}}">
												<div class="comment-body">
													<div class="meta-data">
									...
									<img class="comment-avatar pull-left" alt="" src="{{ asset('asset/images/blog/user3.jpg')}}">
										<div class="comment-body">
											<div class="meta-data">
				...
				<div class="sidebar col s12 m4 l4 xl4">
					<div class="row">
						<div class="col s6 m6 l6 xl6">
							<a href="{{ url('blog') }}" class="btn back"><i class="fa fa-arrow-left"></i> Blog</a>
						</div>
						<div class="col s6 m6 l6 xl6">
						<a href="{{ url('/')}}" class="btn back"><i class="fa fa-home"></i> Home</a>
						</div>
					</div>
					...
					<div class="widget">
						...
						<ul class="arrow nav nav-tabs second-font uppercase">
							@foreach($categories as $category)
								<li>
									<a href="{{ url('blogcategory')}}/{{$category->id}}/{{preg_replace('/\s+/', '-', strtolower($category->name))}}">{{$category->name}}</a>
								</li>
							@endforeach
						</ul>
					</div>
